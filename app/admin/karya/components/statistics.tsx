...
import { statistics } from "@/app/admin/karya/constants/statistics";
import { ADMIN_CREATIONS_CREATE } from "@/constants/route";
      ...
      <div className="mx-auto mt-8 flex w-9/10 flex-col gap-4 sm:flex-row sm:items-end sm:justify-between lg:w-19/20">
        <span className="cursor-default">
          ...
          <p className="mt-1 text-xs text-gray-500 lg:text-sm">
            Kelola karya yang telah diunggah oleh dosen dan mahasiswa.
          </p>
        </span>
        <Link href={ADMIN_CREATIONS_CREATE} className="bg-primary hover:bg-primary/90 flex h-fit w-fit items-center gap-2 rounded-lg px-6 py-3 text-xs font-semibold text-white shadow-lg shadow-blue-500/20 transition-all duration-300 ease-in-out lg:text-sm lg:hover:-translate-y-0.5 lg:active:scale-95">
