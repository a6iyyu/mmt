...
function Avatar({ className, size = "default", ...props }: ComponentProps<typeof Root> & { size?: "default" | "sm" | "lg" }) {
  return (
    <Root
      data-slot="avatar"
      data-size={size}
...
function AvatarImage({ alt = "Avatar", className, ...props }: ComponentProps<typeof Image>) {
  return <Image alt={alt} data-slot="avatar-image" className={cn("aspect-square size-full", className)} {...props} />;
}
