...
export function Footer() {
  return (
    <footer className="bg-primary cursor-default space-y-8 p-8 text-white lg:px-16 lg:py-12">
      <section className="flex flex-col gap-10 lg:flex-row lg:justify-between">
        <article className="space-y-4 lg:basis-1/3">
          <span className="flex items-center gap-4">
            ...
            <h5 className="text-xl font-bold">Lab MMT</h5>
          </span>
          <p className="text-justify text-sm leading-7 text-white/80">
            Laboratorium MMT adalah pusat inovasi dan kreativitas dalam bidang
            multimedia, tempat mahasiswa dan dosen berkolaborasi menciptakan
            karya-karya digital terdepan.
          </p>
        </article>
