  ...
  return (
    <motion.section initial="hidden" animate="visible" variants={container} className="mt-28 flex flex-col items-center justify-between gap-10 px-6 py-16 lg:flex-row">
      ...
      <motion.div className="relative" variants={item}>
        ...
        <span className="from-accent to-secondary absolute -top-4 -right-16 flex h-16 w-16 animate-bounce items-center justify-center rounded-2xl bg-linear-to-br shadow-lg">
          <Code className="h-8 w-8 text-white" />
        </span>
        <span className="from-secondary to-primary absolute -right-24 -bottom-6 flex h-14 w-14 animate-bounce items-center justify-center rounded-2xl bg-linear-to-br shadow-lg">
          <Palette className="h-7 w-7 text-white" />
        </span>
        <span className="from-primary to-hover-blue absolute -top-10 left-8 flex h-12 w-12 animate-bounce items-center justify-center rounded-xl bg-linear-to-br shadow-lg delay-300">
      ...
      <motion.figure className="relative flex flex-col lg:basis-11/20" variants={item}>
        ...
        <span className="border-accent/20 from-accent/10 to-secondary/10 mb-6 inline-flex w-fit items-center rounded-full border bg-linear-to-r px-4 py-2">
          <Sparkles className="text-accent mr-2 h-4 w-4" />
          <h5 className="text-heading cursor-default text-sm font-medium">
            Inovasi Multimedia Terdepan
          </h5>
        </span>
        <h1 className="text-heading mb-4 cursor-default text-2xl leading-14 font-bold lg:text-[44px]">
        ...
        <Button onClick={() => router.push("/karya")} className="from-accent to-secondary hover:from-secondary hover:to-accent group w-fit cursor-pointer rounded-lg border-0 bg-linear-to-r px-7.5! py-6.5 text-sm font-semibold text-white shadow-xl transition-all duration-300 ease-in-out lg:text-base lg:hover:shadow-2xl">
          Jelajahi Karya
