        ...
        <Link href={`/kategori/${category.slug}`} key={index} className="group relative block h-full">
          ...
          >
            ...
            <div className="relative flex-1">
              <h3 className="text-heading group-hover:text-primary mb-3 text-2xl font-bold transition-colors">
                {category.title}
              </h3>
            ...
            <div className="relative mt-auto flex items-center gap-5 border-t border-gray-100 pt-5 text-xs font-semibold text-gray-500">
